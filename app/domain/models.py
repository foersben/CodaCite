...
class Chunk(BaseModel):
    ...
    embedding: list[float] | None = Field(default=None, description="Vector embedding of the chunk text.")
...
class Node(BaseModel):
    ...
    id: str = Field(..., description="Unique identifier for the node (usually the entity name normalized).")
    label: str = Field(..., description="The type/label of the entity (e.g., PERSON, ORGANIZATION).")
    ...
    description_embedding: list[float] | None = Field(default=None, description="Vector embedding of the description.")
    source_chunk_ids: list[str] = Field(default_factory=list, description="IDs of chunks where this entity was found.")
...
class Edge(BaseModel):
    ...
    source_chunk_ids: list[str] = Field(default_factory=list, description="IDs of chunks where this relationship was found.")
...
class Document(BaseModel):
    ...
    metadata: dict[str, str | int | float | bool] = Field(default_factory=dict, description="Additional document metadata.")
...
class Community(BaseModel):
    ...
    node_ids: list[str] = Field(default_factory=list, description="IDs of nodes belonging to this community.")
