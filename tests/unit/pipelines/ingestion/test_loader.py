...
def loader(mocker: Any) -> DocumentLoader:
    ...
    """
    mocker.patch("app.pipelines.ingestion.loader.LocalVLM")
...
def test_load_pdf_with_docling_and_vlm(mocker: Any, tmp_path: Path) -> None:
    ...
    mocker.patch("app.pipelines.ingestion.loader.InputFormat")
    mocker.patch("app.pipelines.ingestion.loader.PdfPipelineOptions")
    mocker.patch("app.pipelines.ingestion.loader.PdfFormatOption")

    mock_vlm_cls = mocker.patch("app.pipelines.ingestion.loader.LocalVLM")
    ...
    # Mock serializer
    mock_serializer_cls = mocker.patch("app.pipelines.ingestion.loader.MarkdownDocSerializer")
